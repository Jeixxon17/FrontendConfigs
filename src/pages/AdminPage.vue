  ...
  <div class="h-full flex flex-col">
    ...
    <template v-if="view === 'list'">
      ...
      <div class="flex items-center justify-between px-6 py-5 border-b border-surface-800/60 shrink-0">
        <div>
          <h1 class="text-xl font-bold text-white font-display">Admin Panel</h1>
          <p class="text-xs text-surface-500 mt-0.5">Create and manage all configurations</p>
        </div>
      ...
      <div class="flex-1 overflow-y-auto">
        ...
        <EmptyState v-else title="No configs found" description="Create your first configuration or adjust your search." icon="⚙️">
          <button @click="startCreate" class="btn-primary mt-4">+ New Config</button>
        </EmptyState>
      </div>
    </template>
